...
Object.entries(n).forEach((([e,o])=>{document.documentElement.style.setProperty(e,o)})),o&&t&&r&&Math.round((299*parseInt(o)+587*parseInt(t)+114*parseInt(r))/1e3)<125&&(adjustCardStyles(),e=LightenDarkenColor(e,50),setThemeColors(e)),document.getElementById("coverdiv").classList.add("loaded"),initThemeColor()}
