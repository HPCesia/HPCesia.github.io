...
t.crossOrigin="Anonymous",t.onload=()=>setThemeColors(rgbToHex(o.getColor(t)),...o.getColor(t)),t.onerror=()=>console.error("Image Error"),t.src=e},rgbToHex=([e,o,t])=>"#"+[e,o,t].map((e=>Math.floor(.8*e).toString(16).padStart(2,"0"))).join(""),setThemeColors=(e,o=null,t=null,r=null)=>{if(!e)return setDefaultThemeColors()
const n={"--efu-main":e,"--efu-main-op":e+"23","--efu-main-op-deep":e+"dd","--efu-main-none":e+"00"}
if(Object.entries(n).forEach((([e,o])=>{document.documentElement.style.setProperty(e,o)})),o&&t&&r){Math.round((299*parseInt(o)+587*parseInt(t)+114*parseInt(r))/1e3)<125&&(adjustCardStyles(),e=LightenDarkenColor(e,50),setThemeColors(e))}document.getElementById("coverdiv").classList.add("loaded"),initThemeColor()}
function LightenDarkenColor(e,o){"#"===e[0]&&(e=e.slice(1))}const adjustCardStyles=()=>{const e=document.getElementsByClassName("card-content")
